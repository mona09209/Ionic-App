...
<ion-grid >
  ...
  <ion-row>
    <ion-col size="6">
        <ion-card >
          <img src="assets/tablet/9.jpeg"  alt="ion">
    <ion-card-header>

<ion-card-title >
  Tablet<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
    </ion-card-header>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/tablet/8.jpeg" alt="ion">
    <ion-card-header>
...
<ion-row>
  <ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/tablet/7.jpeg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/tablet/6.jpeg" alt="ion">
    <ion-card-header>
...
<ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/tablet/5.jpeg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/tablet/4.jpeg" alt="ion">
    <ion-card-header>
...
<ion-card-title>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div class="dic">ADD TO CART</div></ion-button></ion-col>
     ...
     <ion-col size="6">
        <ion-card>
          <img src="assets/tablet/3.jpeg" alt="ion">
    <ion-card-header>
...
Tablet<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
     ...
     <ion-col size="6">
        <ion-card>
          <img src="assets/tablet/9.jpeg" id="i" alt="ion">
    <ion-card-header>
<ion-card-title >
   Tablet<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
