...
<ion-grid >
  ...
  <ion-row>
    <ion-col size="6">
        <ion-card >
          <img src="assets/hair/1.jpg"  alt="ion">
    <ion-card-header>

<ion-card-title >
Hair Dryer<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
    </ion-card-header>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/hair/6.jpg" alt="ion">
    <ion-card-header>
...
<ion-row>
  <ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/hair/7.jpg" alt="ion">
    <ion-card-header>

<ion-card-title >
  Hair Straight<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
    </ion-card-header>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/hair/8.jpg" alt="ion">
    <ion-card-header>
...
<ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/hair/4.jpg" alt="ion">
    <ion-card-header>

<ion-card-title >
   Hair Cropper<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
    </ion-card-header>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/hair/5.jpg" alt="ion">
    <ion-card-header>
