...
<ion-grid >
  ...
  <ion-row>
    <ion-col size="6">
        <ion-card >
          <img src="assets/skhan/1.jpg"  alt="ion">
    <ion-card-header>

<ion-card-title >
 Water Heater<ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
    </ion-card-header>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/skhan/2.jpg" alt="ion">
    <ion-card-header>
...
<ion-row>
  <ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/skhan/3.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/skhan/4.jpg" alt="ion">
    <ion-card-header>
...
<ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/skhan/5.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/skhan/6.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div class="dic">ADD TO CART</div></ion-button></ion-col>
     ...
     <ion-col size="6">
        <ion-card>
          <img src="assets/skhan/7.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
     ...
     <ion-col size="6">
        <ion-card>
          <img src="assets/skhan/8.jpg" alt="ion">
    <ion-card-header>
<ion-card-title >
    Water Heater <ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
