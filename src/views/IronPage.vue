...
<ion-grid >
  ...
  <ion-row>
    <ion-col size="6">
        <ion-card >
          <img src="assets/iron/1.jpg"  alt="ion">
    <ion-card-header>

<ion-card-title >
    iron <ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
    </ion-card-header>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/iron/2.jpg" alt="ion">
    <ion-card-header>
...
<ion-row>
  <ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/iron/3.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/iron/4.jpg" alt="ion">
    <ion-card-header>
...
<ion-row>
    <ion-col size="6">
        <ion-card>
          <img src="assets/iron/5.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
    ...
    <ion-col size="6">
              <ion-card>
          <img src="assets/iron/6.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title>
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div class="dic">ADD TO CART</div></ion-button></ion-col>
     ...
     <ion-col size="6">
        <ion-card>
          <img src="assets/iron/7.jpg" alt="ion">
    <ion-card-header>
...
<ion-card-title >
 ...
 <ion-footer><ion-row>
  <ion-col center text-center><ion-button expand="block" v-on:click="counter+=1"><div>ADD TO CART</div></ion-button></ion-col>
     ...
     <ion-col size="6">
        <ion-card>
          <img src="assets/iron/8.jpg" alt="ion">
    <ion-card-header>
<ion-card-title >
    iron <ion-badge color="warning" ><ion-label>$</ion-label>1000</ion-badge>
</ion-card-title>   
